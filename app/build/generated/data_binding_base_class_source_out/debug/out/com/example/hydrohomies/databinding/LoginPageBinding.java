...
public final class LoginPageBinding implements ViewBinding {
  ...
  private LoginPageBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView4,
      @NonNull SignInButton loginButton, @NonNull TextView textView) {
  ...
  public static LoginPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      SignInButton loginButton = ViewBindings.findChildViewById(rootView, id);
      if (loginButton == null) {
        break missingId;
      }
      ...
      return new LoginPageBinding((ConstraintLayout) rootView, imageView4, loginButton, textView);
    }

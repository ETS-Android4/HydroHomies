...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  private FragmentDashboardBinding(@NonNull ConstraintLayout rootView, @NonNull BarChart chart) {
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDashboardBinding((ConstraintLayout) rootView, chart);
    }
